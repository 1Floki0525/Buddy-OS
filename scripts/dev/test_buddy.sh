...
curl -s -X POST http://localhost:8000/execute -H "Content-Type: application/json" -d '{"action": "window_management", "params": {"action": "find", "title": "Buddy Console"}}'
